...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="oct_inference_without_adapter", help="run model name")
    ...
    parser.add_argument("--sam_checkpoint", type=str, default="workdir/models/oct_training/epoch15_sam.pth", help="sam checkpoint")
    ...
    parser.add_argument("--prompt_path", type=str, default='workdir/256_prompt.json', help="fix prompt path")
